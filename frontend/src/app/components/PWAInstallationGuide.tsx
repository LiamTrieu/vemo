...
/* ---------------------------
   ...
   --------------------------- */
const GuideButton: React.FC<{ onClick: () => void; color: string }> =
    React.memo(({ onClick, color }) => {
        return (
            <motion.button
                onClick={onClick}
                whileHover={{ scale: 1.05 }}
                                ...
                                <Card>
                                    <div className="flex justify-between mb-6">
                                        <div className="flex items-center">
                                            ...
                                            <h3
                                                className={`text-2xl font-bold bg-gradient-to-br ${cfg.color} bg-clip-text text-transparent`}
                                            >
                                                {cfg.title}
                                            </h3>
                                        </div>
                                        {isInstallable && navigator.userAgent.toLowerCase().indexOf(cfg.id) > -1 && cfg.id !== "ios" && (
                                            <motion.button
