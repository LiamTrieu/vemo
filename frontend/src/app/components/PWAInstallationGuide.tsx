...
const Tabs: React.FC<{
  ...
  return (
    <div className="bg-surface relative flex w-full overflow-hidden rounded-lg p-1">
      {/* Moving Background */}
      <motion.div
        layout
        ...
        className={`absolute top-0 left-0 h-full w-1/2 rounded-lg ${
          active === 'ios'
            ? 'from-primary bg-gradient-to-br to-blue-700'
      ...
      <motion.button
        ...
        className={`relative z-10 flex-1 cursor-pointer rounded-lg py-2 text-center font-semibold transition-all duration-300 ${
          active === 'ios'
    ...
    <div className="space-y-4">
      {steps.map(([title, desc], i) => (
        <div key={i} className="flex items-start space-x-3">
          <div
            className={`h-6 w-6 bg-gradient-to-br ${color} mt-1 flex items-center justify-center rounded-full text-sm font-bold text-white`}
          >
            {i + 1}
          </div>
          <div>
  ...
  ({ onClick, color }) => {
    return (
      <motion.button
        ...
        whileHover={{ scale: 1.05 }}
        whileTap={{ scale: 0.95 }}
        className={`mt-3 w-full cursor-pointer rounded-lg bg-gradient-to-br py-2 text-center font-semibold text-white transition-all duration-300 md:hidden ${color}`}
...
const PhonePreview: React.FC<{
  ...
  return (
    <div className="relative hidden items-center justify-center md:flex">
      <div className="relative flex h-[600px] w-[289px] items-center justify-center overflow-hidden px-[10px]">
        <Image
          width={289}
          height={600}
                ...
                <div className="relative flex flex-col items-center justify-center">
                  ...
                  <div className="mt-4">
                    <motion.button
                      ...
                      onClick={onClose}
                      className={`cursor-pointer rounded-lg bg-gradient-to-br px-5 py-2 text-center font-semibold ${color} text-white`}
                    >
                      Đã hiểu
                    </motion.button>
                  </div>
    ...
    <section className="py-16">
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="mb-12 text-center">
          <h2 className="from-primary bg-gradient-to-r to-purple-500 bg-clip-text pb-6 text-4xl font-bold text-transparent md:text-5xl">
            Cài đặt Vemo thành ứng dụng
          </h2>
        ...
        <div className="grid items-center gap-8 md:grid-cols-2">
          ...
          <div>
            <div className="flex flex-col items-center">
              ...
              >
                <div className="bg-surface relative rounded-2xl p-6">
                  <div className="pointer-events-none absolute inset-0 bg-[url('https://marveltheme.com/tf/html/aimug/images/shapes/solutions-two-shape-1.png')] bg-cover bg-center bg-no-repeat"></div>
                  <div className="mb-6 flex justify-between">
                    <div className="flex items-center">
                      <div
                        className={`h-10 w-10 bg-gradient-to-br ${cfg.color} mr-4 flex items-center justify-center rounded-lg text-white`}
                      >
                      ...
                      <h3
                        className={`bg-gradient-to-br text-2xl font-bold ${
                          cfg.id === 'ios'
                            ? 'from-primary bg-gradient-to-br to-blue-700'
                            : 'from-primary bg-gradient-to-br to-green-600'
                    ...
                    {isInstallable &&
                      navigator.userAgent.toLowerCase().indexOf(cfg.id) > -1 &&
                      cfg.id !== 'ios' && (
                        <motion.button
                          ...
                          whileTap={{ scale: 0.9 }}
                          transition={{ duration: 0.3 }}
                          className="from-primary flex items-center justify-center gap-1 rounded-lg bg-gradient-to-br to-green-600 px-2 py-1 text-sm font-semibold text-white shadow-lg"
                        >
                          <ArrowBigDownDash />
